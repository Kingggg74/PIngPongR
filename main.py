...
height = int(info.current_h * 0.75)
...
player1 = Player1('player.png', 15, 150, width -40, 200, 1)
player2 = Player2('player.png', 15, 150, 25, 200, 1)
#ball = Ball('player.png', int(width * 0.45), int(height * 0.80), 5)
